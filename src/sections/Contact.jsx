        ...
        <div className="lg:w-full text-center lg:text-left lg:pl-20">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-center lg:justify-start mb-2">
              <div className="bg-[#1e3a8a] text-white rounded-full p-3 mr-4">
          ...
          <div>
            ...
            <div className="flex space-x-4 justify-center lg:justify-start">
              <a href="#" className="bg-transparent border border-gray-700 text-white rounded-full p-3 hover:bg-gray-700 transition duration-300">
